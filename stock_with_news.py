...
df = pd.read_csv("C:/Users/jorseng/OneDrive - 365.um.edu.my/UM/Units/02 WQD7005 Data Mining/Assignments/Mile Stone 4 - Intepretation/stock_df.csv")
...
with open('C:/Users/jorseng/OneDrive - 365.um.edu.my/UM/Units/02 WQD7005 Data Mining/Assignments/Mile Stone 4 - Intepretation/news.json') as json_file:
    data = json.loads(json_file.read())

# Put the news content into csv file
...
news_df.to_csv('C:/Users/jorseng/OneDrive - 365.um.edu.my/UM/Units/02 WQD7005 Data Mining/Assignments/Mile Stone 4 - Intepretation/news.csv', encoding='utf-8')
...
news_csv = pd.read_csv("C:/Users/jorseng/OneDrive - 365.um.edu.my/UM/Units/02 WQD7005 Data Mining/Assignments/Mile Stone 4 - Intepretation/news.csv", index_col=0)
...
# news1.content.head(5)
#Convert list to strings and apply polarity scores
